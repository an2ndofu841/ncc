...
const INFO_ROWS = [
  ...
  { label: "設立", value: "2011年4月1日（※例示）" },
  {
    label: "所在地",
    value: "〒100-0001 東京都千代田区千代田1-1-1 〇〇ビル5F（※例示）",
  },
  {
    label: "電話",
    value: "03-0000-0000（代表）（※例示・平日9:00〜17:00）",
  },
  { label: "FAX", value: "03-0000-0001（※例示）" },
  {
    label: "メール",
    value: "info@example.or.jp（※例示・お問い合わせはフォームをご利用ください）",
  },
];
